...
document.querySelector(".top-box-a").innerHTML=`<h3>${temp}&deg;C</h3><h3>Delhi</h3><img src="http://openweathermap.org/img/w/${d.weather[0].icon}.png"><h3>${d.weather[0].main}</h3><h3 class="date"></h3>`;
getDate();
...
function getweather(){
   ajaxweather('https://api.openweathermap.org/data/2.5/weather?q=Delhi,in&appid=22e0ccf35e1e3fe7bc730cbbc7618648');
